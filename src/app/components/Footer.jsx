...
const Footer = () => {
  ...
  let footer =
    path === "/login" || path === "/register" ? (
      ...
      <footer className=" dark:bg-gray-900 mt-[20px] text-yellow-50 bg-gradient-to-r from-[#ba704f]  to-[#6c3428]">
        <div className="container p-6 mx-auto">
          <div className="lg:flex">
            <div className="w-full -mx-6 lg:w-2/5">
              <div className="px-6">
                <Link href={"/"}>
                  <span className="text-[#dfa878] font-bold text-3xl">B</span>
                  log
                </Link>

                <p className="text-yellow-50 max-w-sm mt-2 dark:text-gray-400">
          ...
          <div>
            <p className="text-center text-gray-500 dark:text-gray-400">
              © Mahbub 2023 - All rights reserved
            </p>
          </div>
        </div>
      </footer>
